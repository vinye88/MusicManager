## based on spotipy's project https://github.com/plamere/spotipy
...
class GenericOauthError(Exception):
    pass
...
class GenericClientCredentials(object):
    def __init__(self, OAUTH_TOKEN_URL, client_id=None, client_secret=None, proxies=None):
        ...
        constructor or set CLIENT_ID and CLIENT_SECRET
        ...
        if not client_secret:
            raise GenericOauthError('No client secret')
    ...
    def _request_access_token(self):
        ...
        if response.status_code != 200:
            raise GenericOauthError(response.reason)
...
class GenericOAuth(object):
    '''
    Implements Authorization Code Flow for a generic's OAuth implementation.
    '''
    def __init__(self, OAUTH_AUTHORIZE_URL, OAUTH_TOKEN_URL, client_id, client_secret, redirect_uri,
            state=None, scope=None, cache_path=None, proxies=None):
        '''
            Creates a GenericOAuth object
            Parameters:
